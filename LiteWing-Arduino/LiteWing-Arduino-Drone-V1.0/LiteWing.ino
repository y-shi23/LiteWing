...
void setup() {
  ...
  mpu.setDLPFMode(MPU6050_DLPF_BW_42);             // Set digital low-pass filter DLPF at 42Hz
  mpu.setFullScaleAccelRange(MPU6050_ACCEL_FS_8);  // Set accelerometer range to ±8g, meaning 4096 LSB/g
  mpu.setFullScaleGyroRange(MPU6050_GYRO_FS_500);  // Set gyro range to ±500°/s, meaning 65.5 LSB/ deg per second
